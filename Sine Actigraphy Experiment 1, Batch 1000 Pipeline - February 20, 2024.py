...
Trails_BA_Y =  sine_cog.iloc[:,[17]]
Trails_B_Y = sine_cog.iloc[:,[16]]
Trails_A_Y = sine_cog.iloc[:,[15]]
...
train_sine_DSST_dataloader = DataLoader(dataset=train_sine_DSST_data, batch_size=1000, shuffle=True)

val_sine_DSST_data = Data(X_sine_DSST_val, Y_sine_DSST_val_1)
val_sine_DSST_dataloader = DataLoader(dataset=val_sine_DSST_data, batch_size=1000, shuffle=True)
...
plt.grid(False)
plt.savefig("/Sine/DSST/Experiment1/Batch1000_heat.png", dpi=300)
...
with open('/Sine/DSST/Experiment1/Batch1000_top5trials.txt', 'w') as file:
...
plt.savefig("/Sine/DSST/Experiment1/Batch1000_best5.png", dpi=300)

...
train_full_DSST_dataloader = DataLoader(dataset=train_full_DSST_data, batch_size=10000, shuffle=True)

val_full_DSST_data = Data(X_full_DSST_val, Y_full_DSST_val_1)
val_full_DSST_dataloader = DataLoader(dataset=val_full_DSST_data, batch_size=10000, shuffle=True)
...
plt.grid(False)
plt.savefig("Full/DSST/Experiment1/Batch10000_heat.png", dpi=300)
...
with open('/Full/DSST/Experiment1/Batch10000_top5trials.txt', 'w') as file:
...
plt.savefig("/Full/DSST/Experiment1/Batch10000_best5.png", dpi=300)

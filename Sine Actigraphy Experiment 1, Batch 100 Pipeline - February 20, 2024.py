...
train_sine_DSST_dataloader = DataLoader(dataset=train_sine_DSST_data, batch_size=100, shuffle=True)

val_sine_DSST_data = Data(X_sine_DSST_val, Y_sine_DSST_val_1)
val_sine_DSST_dataloader = DataLoader(dataset=val_sine_DSST_data, batch_size=100, shuffle=True)
...
plt.grid(False)
plt.savefig("/Sine/DSST/Experiment1/Batch100_heat.png", dpi=300)
...
with open('/Sine/DSST/Experiment1/Batch100_top5trials.txt', 'w') as file:
...
plt.savefig("/Sine/DSST/Experiment1/Batch100_best5.png", dpi=300)
